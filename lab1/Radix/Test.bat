...
rem При следующим после максимального значении ожидается ненулевой код возврата
%PROGRAM% 10 10 2147483648 >nul
if NOT ERRORLEVEL 1 goto err
echo Test 18 passed

rem При значении следующим перед максимальным значением ожидается нулевой код возврата
...
rem При следующим перед минимального значении ожидается ненулевой код возврата
%PROGRAM% 10 10 -2147483648 >nul
if NOT ERRORLEVEL 1 goto err
echo Test 21 passed

rem При значении следующим за минимальным значением ожидается нулевой код возврата
%PROGRAM% 10 10 -2147483646 >nul
if ERRORLEVEL 1 goto err
echo Test 22 passed
